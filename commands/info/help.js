...
function getAll(client, message) {
    ...
    const embed = new MessageEmbed()
        .setColor('RANDOM')
        .setAuthor(`${client.user.username}'s command`, icon_url = 'https://raw.githubusercontent.com/MarcuXNg/Mus1que/main/assets/logo.gif?token=GHSAT0AAAAAABQGIEUIZVYOAZACNOYW63YKYPFIDWQ')
        .setFields(
            {
                name: "✨ Support ",
